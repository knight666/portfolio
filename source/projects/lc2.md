...
![Design for the new local player selector.][3]
...
![Above: the context bar when using a gamepad. Below: when using mouse and keyboard.][2]
...
![The graphics settings screen in the PC version of _Lara Croft and the Temple of Osiris_.][1]
...
![The text chat widget in action.][2]
...
![The voice chat widget can be displayed at any time.][1]
...
[3]: LC2_PlayerSelectorConcept.png "{ "orientation": "right" }"
[4]: LC2_MainMenu.png "{ "orientation": "left" }"